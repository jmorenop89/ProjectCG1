...
demo = {
    ...
    initFullScreenGoogleMap: function(){
        var myLatlng = new google.maps.LatLng(-12.1035292,-77.0495708);
        var mapOptions = {
          zoom: 13,
          center: myLatlng,
          scrollwheel: false, //we disable de scroll over the map, it is a really annoing when you scroll through page
        ...
        var marker = new google.maps.Marker({
            position: myLatlng,
            icon : '/assets/img/marker-carrito@2x.png',
            map: map
        });

        var marker1 = new google.maps.Marker({
            position:new google.maps.LatLng(-12.0858646,-77.0588289),
            icon : '/assets/img/marker-carrito@2x.png',
            map: map
        });

        var marker2 = new google.maps.Marker({
            position:new google.maps.LatLng(-12.0889061,-77.0419415),
            icon : '/assets/img/marker-carrito@2x.png',
            map: map
        });
    ...
    initStatsDashboard: function(){
        ...
        var dataSales = {
            labels: ['16 NOV', '17 NOV', '18 NOV', '19 NOV', '20 NOV', '21 NOV', '22 NOV', '23 NOV'],
            series: [
        ...
        var data = {
          ...
          series: [
            [20, 12, 50, 90, 20, 50, 100, 30, 29, 20, 100, 200]
          ]
        };
